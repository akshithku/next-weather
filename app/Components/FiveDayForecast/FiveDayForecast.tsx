...
function FiveDayForecast() {
    ...
    // console.log("Five city day: ", city);
    ...
    // console.log("daily data",dailyForecast)

  return (
    <div className='pt-6 pb-5 px-4 flex-1 border rounded-lg flex flex-col justify-between dark:dg-dark-grey shadow-sm dark:shadow-none'>
        <div>
